...
function set_article_group($panel, $type, $name){
  ...
  $panel
    ->section(ucfirst($type).'['.$name.']')
      ...
      ->control('checkbox', $kp.'[use_as_deprecated]')
...
$customizer->UI->build()->panel('appearance', array('title' => 'Appearance'))
  ...
  ->section('breadcrumb', array('title' => 'Breadcrumb'))
    ->control('color', 'theme_breadcrumb_background_color')
    ->control('color', 'theme_breadcrumb_font_color')
